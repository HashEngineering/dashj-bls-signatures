...
%typemap(jstype) bls::ExtendedPublicKey "org.dash.blssignatures.ExtendedPublicKey" // the C/C++ type bls::ExtendedPublicKey corresponds to the JAVA type org.dash.blssignatures.ExtendedPublicKey (jstype: C++ type corresponds to JAVA type)
...
%typemap(javaout) bls::ExtendedPublicKey {
     return new org.dash.blssignatures.ExtendedPublicKey($jnicall, $owner);
}
*/
