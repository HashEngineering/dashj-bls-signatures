...
public class AggregationInfo {
  ...
  public static AggregationInfo FromVectors(PublicKeyVector pubKeys, ByteArrayVector messageHashes, BigIntegerVec exponents) {
    return new AggregationInfo(blssignaturesJNI.AggregationInfo_FromVectors(PublicKeyVector.getCPtr(pubKeys), pubKeys, ByteArrayVector.getCPtr(messageHashes), messageHashes, BigIntegerVec.getCPtr(exponents), exponents), true);
  }
