...
public class PrivateKey {
  ...
  public static PrivateKey AggregateInsecure(PrivateKeyVector privateKeys) {
    return new PrivateKey(blssignaturesJNI.PrivateKey_AggregateInsecure(PrivateKeyVector.getCPtr(privateKeys), privateKeys), true);
  }

  public static PrivateKey Aggregate(PrivateKeyVector privateKeys, SWIGTYPE_p_std__vectorT_PublicKey_t pubKeys) {
    return new PrivateKey(blssignaturesJNI.PrivateKey_Aggregate(PrivateKeyVector.getCPtr(privateKeys), privateKeys, SWIGTYPE_p_std__vectorT_PublicKey_t.getCPtr(pubKeys)), true);
  }
